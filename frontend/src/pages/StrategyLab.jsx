          ...
          >
            <div className="flex items-start justify-between mb-3">
              <div className="flex-1">
                ...
                <span className="text-[10px] font-mono uppercase text-[#6B7280] mt-1 inline-block">
                  {strategy.timeframe}
                </span>
              </div>
              ...
              <button
                ...
                data-testid={`strategy-toggle-${idx}`}
              >
            ...
            <div className="grid grid-cols-2 gap-3 pt-3 border-t border-[#1F2937]">
              <div>
                <span className="text-[10px] font-mono uppercase text-[#6B7280]">Win Rate</span>
                <div className="text-base font-mono font-medium text-[#F9FAFB] mt-1">{strategy.win_rate}%</div>
              </div>
              <div>
                <span className="text-[10px] font-mono uppercase text-[#6B7280]">Avg R:R</span>
                <div className="text-base font-mono font-medium text-[#F9FAFB] mt-1">{strategy.avg_rr}</div>
              </div>
              <div className="col-span-2">
                <span className="text-[10px] font-mono uppercase text-[#6B7280]">Best Regime</span>
                <div className="text-sm text-[#F9FAFB] mt-1">{strategy.best_regime?.replace('_', ' ')}</div>
              </div>
            </div>
            
            <button
              className="mt-4 w-full bg-[#1F2937] text-[#F9FAFB] hover:bg-[#374151] px-3 py-1.5 text-sm font-medium rounded-sm transition-colors"
              data-testid={`backtest-button-${idx}`}
            >
              Run Backtest
            </button>
          </div>
